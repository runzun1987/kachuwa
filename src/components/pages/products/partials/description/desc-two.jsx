                    ...
                    <div className="container">
                      <div className="row">
                        <div className="col-md-6">
                          <h2>Design</h2>
                          <p>
                            The perfect choice for the summer months. These
                            wedges are perfect for holidays and home, with the
                            thick cross-over strap design and heel strap with an
                            adjustable buckle fastening. Featuring chunky soles
                            with an espadrille and cork-style wedge.{' '}
                          </p>
                        </div>
                        ...
                        <div className="col-md-6">
                          <h2>Fabric & care</h2>
                          <p>
                            As part of our Forever Comfort collection, these
                            wedges have ultimate cushioning with soft padding
                            and flexi soles. Perfect for strolls into the old
                            town on holiday or a casual wander into the village.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="row">
                        <div className="col-lg-5">
                          ...
                          <p>
                            ...
                            egestas, ante et vulputate volutpat, eros pede
                ...
                <div className="product-desc-content">
                  <div className="container">
                    ...
                    <p>
                      ...
                      <br />
                      We hoope you’ll love every purchase, but if you ever need

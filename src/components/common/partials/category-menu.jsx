...
function CategoryMenu() {
  ...
  const LaptopComputer = (e) => {
    const keyword = e.target.innerText;
    history.push(`/shop/boxed/keyword/${keyword}/default/` + Math.random());
  };
  ...
  return (
    <div className={`dropdown category-dropdown is-on`}>
      ...
      <div className={`dropdown-menu`}>
        <nav className="side-nav" onClick={LaptopComputer}>
                      ...
                      <div className="row">
                        <div className="col-md-6">
                          ...
                          <ul>
                            ...
                            <li>
                              <Link to="#">Hard Drives &amp; Storage</Link>
                            </li>
                            <li>
                          ...
                          <ul>
                            ...
                            <li>
                              <Link to="#">Home Audio Speakers</Link>
                            </li>
                            <li>
                              <Link to="#">Projectors</Link>
                            </li>
                            <li>
                              <Link to="#">Media Streaming Devices</Link>
                            </li>
                          </ul>
                        </div>
                        ...
                        <div className="col-md-6">
                          ...
                          <ul>
                            <li>
                              <Link to="#">Digital SLR Cameras</Link>
                            </li>
                            <li>
                              <Link to="#">Sports &amp; Action Cameras</Link>
                            </li>
                            <li>
                            ...
                            <li>
                              <Link to="#">Photo Printer</Link>
                            </li>
                            <li>
                              <Link to="#">Digital Memory Cards</Link>
                            </li>
                            <li>
                              <Link to="#">
                    ...
                    <div className="menu-col">
                      <div className="row">
                        <div className="col-md-6">
                          ...
                          <ul>
                            <li>
                              <Link to="#">Beds, Frames &amp; Bases</Link>
                            </li>
                            <li>
                              <Link to="#">Dressers</Link>
                            </li>
                            <li>
                              <Link to="#">Nightstands</Link>
                            </li>
                            <li>
                              <Link to="#">Kids' Beds &amp; Headboards</Link>
                            </li>
                            <li>
                          ...
                          <ul>
                            ...
                            <li>
                              <Link to="#">Futons &amp; Sofa Beds</Link>
                            </li>
                            <li>
                              <Link to="#">Cabinets &amp; Chests</Link>
                            </li>
                          </ul>
                        </div>
                        ...
                        <div className="col-md-6">
                          ...
                          <ul>
                            ...
                            <li>
                              <Link to="#">Bookcases</Link>
                            </li>
                            <li>
                              <Link to="#">File Cabinets</Link>
                            </li>
                            <li>
                              <Link to="#">Breakroom Tables</Link>
                            </li>
                          </ul>
                          ...
                          <ul>
                            ...
                            <li>
                              <Link to="#">Kitchen Storage Cabinets</Link>
                            </li>
                            <li>
                              <Link to="#">Bakers Racks</Link>
                            </li>
                            <li>
                ...
                <div className="menu-col">
                  <div className="row">
                    <div className="col-md-4">
                      ...
                      <ul>
                        <li>
                          <Link to="#">Cookware Sets</Link>
                        </li>
                        <li>
                          <Link to="#">Pans, Griddles &amp; Woks</Link>
                        </li>
                        <li>
                          <Link to="#">Pots</Link>
                        </li>
                        <li>
                          <Link to="#">Skillets &amp; Grill Pans</Link>
                        </li>
                        <li>
                          <Link to="#">Kettles</Link>
                        </li>
                        <li>
                          <Link to="#">Soup &amp; Stockpots</Link>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="col-md-4">
                      ...
                      <ul>
                        ...
                        <li>
                          <Link to="#">Cups &amp; Mugs</Link>
                        </li>
                        <li>
                          <Link to="#">Trays &amp; Platters</Link>
                        </li>
                        <li>
                          <Link to="#">Coffee &amp; Tea Serving</Link>
                        </li>
                        <li>
                          <Link to="#">Salt &amp; Pepper Shaker</Link>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="col-md-4">
                      ...
                      <ul>
                        ...
                        <li>
                          <Link to="#">Mixers &amp; Attachments</Link>
                        </li>
                        <li>
                          <Link to="#">Slow Cookers</Link>
                        </li>
                        <li>
                          <Link to="#">Air Fryers</Link>
                        </li>
                        <li>
                  ...
                  <div className="row menu-banners">
                    <div className="col-md-4">
                      <div className="banner">
                        <Link to="#">
                          <img
                            src={`${process.env.PUBLIC_URL}/assets/images/home/menu/1.jpg`}
                            alt="banner"
                          />
                        </Link>
                      </div>
                    ...
                    <div className="col-md-4">
                      <div className="banner">
                        <Link to="#">
                          <img
                            src={`${process.env.PUBLIC_URL}/assets/images/home/menu/2.jpg`}
                            alt="banner"
                          />
                        </Link>
                      </div>
                    ...
                    <div className="col-md-4">
                      <div className="banner">
                        <Link to="#">
                          <img
                            src={`${process.env.PUBLIC_URL}/assets/images/home/menu/3.jpg`}
                            alt="banner"
                          />
                        </Link>
                      </div>
                ...
                <div className="row no-gutters">
                  ...
                  <div className="col-md-4">
                    <div className="banner banner-overlay">
                      ...
                      >
                        <img
                          src={`${process.env.PUBLIC_URL}/assets/images/home/menu/banner-3.jpg`}
                          alt="Banner"
                        />
                      </Link>
                    </div>
                  ...
                  <div className="row">
                    <div className="col-lg-2">
                      <Link to="#" className="brand">
                        <img
                          src={`${process.env.PUBLIC_URL}/assets/images/brands/1.png`}
                          alt="Brand Name"
                        />
                      </Link>
                    </div>
                    ...
                    <div className="col-lg-2">
                      <Link to="#" className="brand">
                        <img
                          src={`${process.env.PUBLIC_URL}/assets/images/brands/2.png`}
                          alt="Brand Name"
                        />
                      </Link>
                    </div>
                    ...
                    <div className="col-lg-2">
                      <Link to="#" className="brand">
                        <img
                          src={`${process.env.PUBLIC_URL}/assets/images/brands/3.png`}
                          alt="Brand Name"
                        />
                      </Link>
                    </div>
                    ...
                    <div className="col-lg-2">
                      <Link to="#" className="brand">
                        <img
                          src={`${process.env.PUBLIC_URL}/assets/images/brands/4.png`}
                          alt="Brand Name"
                        />
                      </Link>
                    </div>
                    ...
                    <div className="col-lg-2">
                      <Link to="#" className="brand">
                        <img
                          src={`${process.env.PUBLIC_URL}/assets/images/brands/5.png`}
                          alt="Brand Name"
                        />
                      </Link>
                    </div>
                    ...
                    <div className="col-lg-2">
                      <Link to="#" className="brand">
                        <img
                          src={`${process.env.PUBLIC_URL}/assets/images/brands/6.png`}
                          alt="Brand Name"
                        />
                      </Link>
                    </div>

      ...
      {type === 'normal' ? (
        ...
        <div className={`${container}  d-flex align-items-center`}>
          ...
          <nav className="product-pager ml-auto" aria-label="Product">
            {/* {prevProduct && <Link className="product-pager-link product-pager-prev" to={ `${process.env.PUBLIC_URL}/${type}/${slug}/${prevProduct.id}` } aria-label="Previous" tabIndex="-1">
                            ...
                            {nextProduct && <Link className="product-pager-link product-pager-next" to={ `${process.env.PUBLIC_URL}/${type}/${slug}/${nextProduct.id}` } aria-label="Next" tabIndex="-1">
                                <span>Next</span>

...
import { whichList } from '../../actions/index';

import data from '../../mock_data/data';
import style from './style.scss';
import { withAuthenticator } from 'aws-amplify-react';

function HomePage({ whichList }) {
  whichList('');
  useEffect(() => {
              ...
              <div className="intro-slider-container slider-container-ratio mb-2">
                ...
                >
                  {data.introBanners.map((item, index) => {
                    return <Introslide slide={item} key={`intro_${index}`} />;
                  })}
                </OwlCarousel>
...
export default withAuthenticator(connect(null, { whichList })(HomePage), true);

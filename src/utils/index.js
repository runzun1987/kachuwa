...
export const mobileMenu = function(e) {
  ...
  if (document.querySelector('.mobile-menu')) {
    items = document.querySelector('.mobile-menu').querySelectorAll('li');
  }
...
export const productGalleryTwo = () => {
  let items = document.querySelectorAll('.kachuwa-small-images');
